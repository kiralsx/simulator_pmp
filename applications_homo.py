...
class Application(object):
    def __init__(self, trace_dir, cluster_suffix=None, 
                 ...
                 max_epochs=None, target_metric=None, multipliers=dict()):
...
APPLICATIONS = {
    "bert": Application(os.path.join(TRACES_DIR, "bert"), max_epochs=2, multipliers={"slow" : 0.4, "fast": 1.6}),
    "cifar10": Application(os.path.join(TRACES_DIR, "cifar10"), max_epochs=100, multipliers={"slow" : 0.8, "fast": 1.2}),
    "ncf": Application(os.path.join(TRACES_DIR, "ncf"), max_epochs=10, multipliers={"slow" : 0.8, "fast": 1.2}),
    "imagenet": Application(os.path.join(TRACES_DIR, "imagenet"), max_epochs=90, multipliers={"slow" : 0.5, "fast": 1.5}),
    "deepspeech2": Application(os.path.join(TRACES_DIR, "deepspeech2"), max_epochs=80, multipliers={"slow" : 0.6, "fast": 1.4}),
    "yolov3": Application(os.path.join(TRACES_DIR, "yolov3"), max_epochs=50, max_local_bsz=8, multipliers={"slow" : 0.5, "fast": 1.5}),
}
